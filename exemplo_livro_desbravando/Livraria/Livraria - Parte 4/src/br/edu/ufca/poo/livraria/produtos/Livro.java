...
public abstract class Livro implements Produto{
    ...
    /*
     * Agora que estamos utilizando uma interface, o método aplicarDesconto() irá para
     * a interface e, apenas aquelas classes que assinarem o contrato com a interface irão
