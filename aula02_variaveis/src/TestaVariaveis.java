public class TestaVariaveis {
    ...
    public static void main(String[] args) {
         ...
         */
         ...
         double altura = 1.70;
         System.out.println("A altura é: " + altura); //1.7

         int divisao = 5/2;
         System.out.println(divisao); // Saída: 2

         double novaTentativa = 5/2;
         System.out.println(novaTentativa); // Saída: 2.0

         double outraTentativa = 5.0/2;
         System.out.println(outraTentativa); // Saída: 2.5
    }
}